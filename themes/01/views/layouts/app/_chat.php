                                    ...
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/1x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/1.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/1x.jpg" class="col-top">
                                            </span>
                                        </span>
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/2x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/2.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/2x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/3x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/3.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/3x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/4x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/4.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/4x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/5x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/5.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/5x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/6x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/6.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/6x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/7x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/7.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/7x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                            ...
                            <ul>
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/8x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/8.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/8x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                                ...
                                <li class="chat-user-list clearfix">
                                    <a data-view-animation="push-parrallax" data-view-port="#chat" data-navigate="view" class="" href="#">
                                        <span class="col-xs-height col-middle">
                                            <span class="thumbnail-wrapper d32 circular bg-success">
                                                <img width="34" height="34" alt="" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/9x.jpg" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/9.jpg" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/9x.jpg" class="col-top">
                                            </span>
                                        </span>
                                        <p class="p-l-10 col-xs-height col-middle col-xs-12">
                    ...
                    <div class="chat-inner" id="my-conversation">
                        ...
                        <div class="message clearfix">
                            <div class="profile-img-wrapper m-t-5 inline">
                                <img class="col-top" width="30" height="30" src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/avatar_small.jpg" alt="" data-src="<?= Yii::app()->theme->baseUrl ?>/img/profiles/avatar_small.jpg" data-src-retina="<?= Yii::app()->theme->baseUrl ?>/img/profiles/avatar_small2x.jpg">
                            </div>
